...
export default async function Page({params}) { const services=await getManagedCatalog("signboards",signboards); const service=services.find((item)=>item.slug===params.slug); if(!service) notFound(); return <CatalogDetail service={service} group="Signboards" related={services} />; }
