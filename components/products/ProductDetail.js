...
export default function ProductDetail({ product }) {
  ...
  const addToCart = async () => {
    if (selected.length !== (product.variants || []).length) return toast.warning("Choose product options", "Select every available option before adding this product.");
